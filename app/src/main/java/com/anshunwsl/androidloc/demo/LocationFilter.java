package com.anshunwsl.androidloc.demo;
...
import com.anshunwsl.androidloc.R;
import com.anshunwsl.androidloc.service.LocationService;
import com.anshunwsl.androidloc.service.Utils;
...
/***
 * 定位滤波demo，实际定位场景中，可能会存在很多的位置抖动
 * ，此示例展示了一种对定位结果进行的平滑优化处理
 * 实际测试下，该平滑策略在市区步行场景下，有明显平滑效果，
 * 有效减少了部分抖动，开放算法逻辑，希望能够对开发者提供帮助
 * 注意：该示例场景仅用于对定位结果优化处理的演示，
 * 里边相关的策略或算法并不一定适用于您的使用场景，请注意！！！
 * 
 * @author baidu
 * 
 */
